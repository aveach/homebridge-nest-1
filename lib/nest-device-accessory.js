...
let Away, EcoMode, HeatMode, FanTimerActive, FanTimerDuration, HasLeaf, ManualTestActive, SunlightCorrectionEnabled, SunlightCorrectionActive, UsingEmergencyHeat;
...
module.exports = function(exportedTypes) {
  if (exportedTypes && !Accessory) {
    ...
    HeatMode = exportedTypes.HeatMode;
...
NestDeviceAccessory.prototype.updateDevicePropertyAsync = async function(property, value, propertyDescription, valueDescription) {
  ...
  return await Promise.resolve(this.conn.update(this.getDevicePropertyPath(property), value)
    .return(value));
};
...
NestDeviceAccessory.prototype.setHeatMode = function (heat, callback) {
...
NestDeviceAccessory.prototype.addHeatModeCharacteristic = function(service) {
  service.addCharacteristic(HeatMode);
  this.bindCharacteristic(service, HeatMode, "Heat Mode", this.isHeatMode, this.setHeatMode);
};
