...
function NestThermostatAccessory(conn, log, device, structure, platform) {
  ...
  if (this.platform.shouldEnableFeature("Thermostat.Heat")) {
    const thermostatEcoModeService = this.addService(Service.Switch, "Heat", "heat_mode");
    this.bindCharacteristic(thermostatEcoModeService, Characteristic.On, "Heat", this.getHeatMode, this.setHeatMode);
  }
