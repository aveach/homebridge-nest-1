...
NestThermostatAccessory.prototype.getCoolingThresholdTemperature = function () {
  ...
  this.log("in getCoolingThresholdTemperature eco block")
    ...
    let ret = this.getTemperatureValueInCelsius('eco_temperature_high_') || this.getTemperatureValueInCelsius('away_temperature_high_');
    this.log(ret);
    return ret;
  case "heat-cool":
  default:
    this.log("in getCoolingThresholdTemperature default block")
    let ret = this.getTemperatureValueInCelsius('target_temperature_high_')
    thsi.log(ret);
    return ret;
  }
};
